...
},next:function(){var d=this.options,c=parseInt(d.activeIndex, 10)+1;if(d.disabled){return false;}if(d.loop){c=c%this.panels.length;}if(c<this.panels.length){this.show(c);
return true;}return false;},back:function(){var d=this.options,c=parseInt(d.activeIndex, 10)-1;if(d.disabled){return false;}if(d.loop){c=c<0?this.panels.length-1:c;}if(c>=0){this.show(c);
