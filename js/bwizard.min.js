...
if(this.list&&c===0){this.list=null;}if(this.list){if(this.list.get(0).tagName.toLowerCase()==="ol"){g=true;}this.lis=a("li",this.list);this.lis.each(function(){a(this).attr("role","tab");
a(this).find(".label").remove();var j=a(this).index()+1;a(this).css("z-index",d.lis.length-j);a(this).contents().wrap('<span class="hidden-phone"/>');a(this).prepend('<span class="label">'+j+"</span>");
