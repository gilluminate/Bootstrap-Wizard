...
return false;}}).attr("role","button");var f=true;}if(f){this.buttons.appendTo(this.element);}}},_removeButtons:function(){if(this.buttons){this.buttons.remove();
...
if(this.list&&c===0){this.list=null;}if(this.list){if(this.list.get(0).tagName.toLowerCase()==="ol"){g=true;}this.lis=a("li",this.list);this.lis.each(function(){a(this).find(".label").remove();
