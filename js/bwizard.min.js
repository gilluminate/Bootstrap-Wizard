 ...
 */
(function(k,h,j){var i=/\+/g;function l(a){return a}function n(a){return decodeURIComponent(a.replace(i," "))}var m=k.cookie=function(e,f,a){if(f!==j){a=k.extend({},m.defaults,a);if(f===null){a.expires=-1}if(typeof a.expires==="number"){var d=a.expires,b=a.expires=new Date();b.setDate(b.getDate()+d)}f=m.json?JSON.stringify(f):String(f);return(h.cookie=[encodeURIComponent(e),"=",m.raw?f:encodeURIComponent(f),a.expires?"; expires="+a.expires.toUTCString():"",a.path?"; path="+a.path:"",a.domain?"; domain="+a.domain:"",a.secure?"; secure":""].join(""))}var u=m.raw?l:n;var c=h.cookie.split("; ");for(var g=0,s;(s=c[g]&&c[g].split("="));g++){if(u(s.shift())===e){var t=u(s.join("="));return m.json?JSON.parse(t):t}}return null};m.defaults={};k.removeCookie=function(a,b){if(k.cookie(a)!==null){k.cookie(a,null,b);return true}return false}})(jQuery,document);
/*!
